...
window.App = {
    start: function() {
        ...
        // Bootstrap the PapyrusToken abstraction for Use.
        PapyrusToken.setProvider(web3.currentProvider);
    ...
    refreshBalance: function() {
        ...
        var meta;
        PapyrusToken.deployed().then(function(instance) {
            meta = instance;
            console.log(meta);
...
window.addEventListener('load', function() {
    ...
    if (typeof web3 !== 'undefined') {
        console.warn("Using web3 detected from external source. If you find that your accounts don't appear or you have 0 PapyrusToken, ensure you've configured that source properly. If using MetaMask, see the following link. Feel free to delete this warning. :) http://truffleframework.com/tutorials/truffle-and-metamask")
